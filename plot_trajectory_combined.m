function plot_trajectory_combined(sol_L, sol_D)
...
% Trajectory and thrust vector plot for Powered Descent Module
plot3(r_D(1,:), r_D(2,:), r_D(3,:),'LineWidth', 2, 'Color', 'red');
q = quiver3(r_D(1,:), r_D(2,:), r_D(3,:), u_D(1,:), u_D(2,:), u_D(3,:));
q.ShowArrowHead = 'off';
q.Color = 'red';
q.LineWidth = 0.25;
